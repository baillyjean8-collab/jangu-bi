...
const ARTICLES = [
  ...
  },
  {
    ...
    categorie: 'vatican',
    titre: "Le Catéchisme de l'Église Catholique — qu'est-ce que la foi ?",
    source: "Source : Catechisme de l'Eglise Catholique, Libreria Editrice Vaticana",
    texte: "Le Catechisme de l'Eglise Catholique, publie en 1992 sous le pontificat de Jean-Paul II, rassemble en un seul ouvrage l'enseignement complet de la foi catholique : le Credo, les sacrements, la vie morale chretienne et la priere. Il a ete concu comme un texte de reference pour aider chaque baptise a mieux connaitre et vivre sa foi.\n\nLe tout premier paragraphe rappelle que Dieu, infiniment parfait et bienheureux en lui-meme, a cree l'homme pour le faire participer a sa propre vie bienheureuse. C'est pourquoi, en tout temps et en tout lieu, Dieu se rend proche de l'homme, l'appelle et l'aide a le chercher, a le connaitre et a l'aimer de toutes ses forces.",
