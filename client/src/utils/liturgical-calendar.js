...
const BIOS = {
  ...
  'transfiguration-du-seigneur': "Selon les Évangiles de Matthieu, Marc et Luc, Jésus emmena un jour Pierre, Jacques et Jean sur une haute montagne, où son visage et ses vêtements devinrent resplendissants de lumière devant eux. Moïse et Élie lui apparurent, s'entretenant avec lui, et une voix venue du ciel proclama : « Celui-ci est mon Fils bien-aimé ». Cet événement annonce par avance la gloire de la Résurrection et fortifie les disciples avant les souffrances de la Passion à venir.",
};
