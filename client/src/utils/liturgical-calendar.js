...
function fetesFixes(annee) {
  return [
    ...
    { mois: 6, jour: 22, titre: 'Sainte Marie-Madeleine', type: 'Fete', couleur: COULEURS.blanc },
    { mois: 6, jour: 23, titre: 'Sainte Brigitte de Suede, copatronne de l Europe', type: 'Fete', couleur: COULEURS.blanc },
    { mois: 6, jour: 25, titre: 'Saint Jacques, apotre', type: 'Fete', couleur: COULEURS.rouge },
    { mois: 6, jour: 26, titre: 'Saints Anne et Joachim, parents de la Vierge Marie', type: 'Memoire obligatoire', couleur: COULEURS.blanc },
    { mois: 6, jour: 29, titre: 'Saintes Marthe, Marie et Lazare', type: 'Memoire obligatoire', couleur: COULEURS.blanc },
    { mois: 6, jour: 31, titre: 'Saint Ignace de Loyola, pretre', type: 'Memoire obligatoire', couleur: COULEURS.blanc },
    { mois: 7, jour: 4, titre: 'Saint Jean-Marie Vianney, pretre (cure d Ars), patron des pretres', type: 'Memoire obligatoire', couleur: COULEURS.blanc },
